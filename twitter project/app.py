...
Database.intiallize(user = 'postgres', password = '123456', host = 'localhost', database = 'learning' )
...
def search():
    ...
    tweets = g.user.twitter_request('https://api.twitter.com/1.1/search/tweets.json?q={}'.format(query_string))
